	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="addContect.jsp"><i class="fa-solid fa-square-plus"></i>
					Add Phone No</a></li>

			<li class="nav-item active"><a class="nav-link"
				href="viewContect.jsp"><i class="fa-sharp fa-solid fa-eye"></i>
					View Contect</a></li>
		</ul>
		...
		<form class="form-inline my-2 my-lg-0">
			<a href="login.jsp" class="btn btn-success"><i
				class="fa-solid fa-users"></i> Login</a> <a href="register.jsp"
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<a data-toggle="modal" data-target="#exampleModalCenter"
				class="btn btn-denger ml-2 text-white">Logout</a>
		</form>
		<%
		}
		%>
